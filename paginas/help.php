...
<div class="text-center">
    <h1 id="genTxtSb2-ask">Qual a sua dúvida <span id="txtBorder-ask">?</span></h1>

    <div id="search-help">
        <form method="GET" action="paginas/search">
            <input type="text" class="search-bar-input" name="s" placeholder="Digite sua dúvida aqui" />
        </form>
    </div>
</div>
<br><br><br>
<div class="text-center">
    <h3 id="genTxtSb2-ask">Dúvidas frequentes</h3>
</div>
<br>
...
<div class='faq'>
    ...
    <label for='faq-a'>
        <p class="faq-heading">Compra de criptomoeda</p>
    ...
    <label for='faq-b'>
        <p class="faq-heading">Depósito em sua conta</p>
        <div class='faq-arrow'></div>
    ...
    <label for='faq-e'>
        <p class="faq-heading">Segurança</p>
        <div class='faq-arrow'></div>
    ...
    <label for='faq-f'>
        <p class="faq-heading">Sua conta</p>
        <div class='faq-arrow'></div>
    ...
    <label for='faq-g'>
        <p class="faq-heading">Indicações</p>
        <div class='faq-arrow'></div>
        <p class="faq-text">If a student does not answer a question in 5 minutes after it pops up the student will be ‘timed out’ and they will lose their progress from the last previously answered question <br><br>This feature is built in to discourage students from playing a video lesson and walking away. Students must stay engaged with the video lesson to avoid being timed out. If you have more questions, please feel free to submit a request!</p>
    </label>
    <input id='settings' type='checkbox'>
    ...
    <label for='faq-h'>
        <p class="faq-heading">Livro de ofertas</p>
        <div class='faq-arrow'></div>
        <p class="faq-text">If a student does not answer a question in 5 minutes after it pops up the student will be ‘timed out’ and they will lose their progress from the last previously answered question <br><br>This feature is built in to discourage students from playing a video lesson and walking away. Students must stay engaged with the video lesson to avoid being timed out. If you have more questions, please feel free to submit a request!</p>
    </label>
</div>
